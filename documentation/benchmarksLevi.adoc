...
(http://cvc4.cs.stanford.edu/web/[CVC4], https://github.com/z3str/Z3-str[Z3str] and https://github.com/mtrberzi/z3/tree/develop[Z3Seq]).
...
include::bechmarkLevi1.txt.table[]
...
include::bechmarkLevi2.txt.table[]
...
include::bechmarkLevi3.txt.table[]


=== Fourth Track
Within the fourth track (IV) each instance consists of a system of 100 small random word
...
include::bechmarkLevi4.txt.table[]


=== Fifth Track
Within the fifth track (V) each instance is an enriched system of 30 word equations with suitable linear constraints, as presented in this paper. This track is influenced by the Kaluza benchmark set.

include::bechmarkLevi5.txt.table[]
