...
(http://cvc4.cs.stanford.edu/web/[CVC4], https://github.com/z3str/Z3-str[Z3str], https://github.com/mtrberzi/z3/tree/develop[Z3Seq] and
http://user.it.uu.se/~jarst116/norn/[Norn], https://github.com/uuverifiers/sloth[Sloth]).
